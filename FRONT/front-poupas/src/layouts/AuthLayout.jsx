...
function AuthLayout() {
  return (
    <div className="min-h-screen flex bg-[#d6d6d6]">
      <div className="w-1/2 bg-linear-to-r from-blue-500 to-purple-600 flex flex-col justify-center items-center text-white p-12 rounded-tr-2xl rounded-br-2xl">
