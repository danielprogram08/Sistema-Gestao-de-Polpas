    ...
    return (
        <div className={`relative ${containerClassName || ''}`}>
            <input
                ...
                value={value}
                onChange={onChange}
                className="block w-full px-4 py-3 text-black bg-white border border-gray-300 rounded-lg appearance-none focus:outline-none focus:ring-0 focus:border-blue-500 peer"
                {...rest}
            />
            <label
                htmlFor={id}
